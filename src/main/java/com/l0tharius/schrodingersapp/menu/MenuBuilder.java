...
public class MenuBuilder {
	...
	private void buildMenu()
	{
		...
		playHeading.add( new MenuItem( 
				...
				"com.l0tharius.schrodingersapp.playlist.PlaylistViewMenuItem"
				));
		...
		playHeading.add( new MenuItem( 
				...
				"com.l0tharius.schrodingersapp.music.MusicViewMenuItem"
				));
		...
		playHeading.add( new MenuItem( 
				...
				"com.l0tharius.schrodingersapp.user.UserViewMenuItem"
				));	
		...
		maintainHeading.add( new MenuItem( 
				...
				"Add User",
				"Add a user",
				"com.l0tharius.schrodingersapp.menu.UndefinedMenuItem"
				));		
